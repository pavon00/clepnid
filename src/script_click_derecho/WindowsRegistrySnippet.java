 ...
 */
public final class WindowsRegistrySnippet {
    /**
    ...
    private WindowsRegistrySnippet() {}
    ...
    public static void main(String[] args) {
    	System.out.println(WindowsRegistrySnippet.isAvailable());
    	WindowsRegistrySnippet.createKey("HKEY_CLASSES_ROOT\\*\\shell\\clepnid");
    	WindowsRegistrySnippet.writeValue("HKEY_CLASSES_ROOT\\*\\shell\\clepnid", "Icon", "C:\\Users\\pavon\\AppData\\Roaming\\.minecraft\\TLauncher.exe");
    	WindowsRegistrySnippet.createKey("HKEY_CLASSES_ROOT\\*\\shell\\clepnid\\command");
    	System.out.println(WindowsRegistrySnippet.readValue("HKEY_CLASSES_ROOT\\*\\shell\\afirma.hashFile", "Icon"));
    }
}