...
public class MultipartFileVideoSender {
    ...
    public MultipartFileVideoSender() {
    }

    public static MultipartFileVideoSender fromPath(Path path) {
        return new MultipartFileVideoSender().setFilepath(path);
    }

    public static MultipartFileVideoSender fromFile(File file) {
        return new MultipartFileVideoSender().setFilepath(file.toPath());
    }

    public static MultipartFileVideoSender fromURIString(String uri) {
        return new MultipartFileVideoSender().setFilepath(Paths.get(uri));
    }

    //** internal setter **//
    private MultipartFileVideoSender setFilepath(Path filepath) {
        this.filepath = filepath;
        return this;
    }

    public MultipartFileVideoSender with(HttpServletRequest httpRequest) {
        request = httpRequest;
        return this;
    }

    public MultipartFileVideoSender with(HttpServletResponse httpResponse) {
