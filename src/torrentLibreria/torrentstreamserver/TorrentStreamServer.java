...
public class TorrentStreamServer {
    ...
    public void startTorrentStream(int index) {
        this.torrentStream = TorrentStream.init(torrentOptions, index);
     ...
     */
    public void startStream(String torrentUrl, File srtSubtitleFile, File vttSubtitleFile){
        if (this.torrentStream == null) {
            System.out.println("no inicializado");
        }
        this.torrentStream.startStream(torrentUrl);

        //this.torrentStreamWebServer = TorrentStreamWebServer.getInstance();
    ...
    private class InternalTorrentServerListener implements TorrentServerListener {
        ...
        public void onStreamReady(Torrent torrent) {
            ...
            //onServerReady(torrentStreamWebServer.getListaStreamUrl());
        }
