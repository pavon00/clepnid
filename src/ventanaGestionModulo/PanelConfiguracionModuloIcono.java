...
public class PanelConfiguracionModuloIcono extends Composite {
	...
	public PanelConfiguracionModuloIcono(Composite parent, int style, Ventana ventana) {
		super(parent, style);
			...
			public void handleEvent(Event event) {
				if (ComprobarInputs()) {
					...
					String escritura = "[\n\t{\n\t\t" + "\"Web\": {\n" + "\t\t\t\"TypeModule\": \"Icono\",\n"
							...
							+ textoBoton.getTextoIntroducido() + "\",\n" + "\t\t\t\"rutaHttp\": \"" + rutaHttpAux
							+ "\",\n" + "\t\t\t\"rutaImagen\": \"" + rutaImagen + "\"\n" + "\t\t}\n" + "\t}\n" + "]"
							+ "";
